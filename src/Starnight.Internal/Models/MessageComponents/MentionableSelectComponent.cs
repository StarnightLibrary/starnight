...
/// <summary>
/// Represents a user + roles select menu, with the selectable options provided by the discord.
/// </summary>
public sealed record MentionableSelectComponent : AbstractInteractiveComponent
{
	public MentionableSelectComponent() => this.Type = DiscordMessageComponentType.MentionableSelect;
