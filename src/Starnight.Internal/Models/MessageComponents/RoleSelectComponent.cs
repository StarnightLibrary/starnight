...
/// <summary>
/// Represents a role select menu, with the selectable options provided by the discord.
/// </summary>
public sealed record RoleSelectComponent : AbstractInteractiveComponent
{
	public RoleSelectComponent() => this.Type = DiscordMessageComponentType.RoleSelect;
