...
/// </summary>
public sealed record DiscordGuildRoleUpdatedEvent : IDiscordGatewayDispatchEvent<GuildRoleUpdatedPayload>
{
	/// <inheritdoc/>
	[JsonPropertyName("s")]
	...
	/// <inheritdoc/>
	[JsonPropertyName("d")]
	public required GuildRoleUpdatedPayload Data { get; set; }
